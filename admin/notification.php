...
<form action="" method="POST" enctype="multipart/form-data">
    <div class="row mt-5">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
            ...
            <div class="row my-5">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-10">
                    <input type="text" class="form-control border border-gray" id="title" name="title" required>
                </div>
            </div>

            <div class="row my-4">
                <label for="description" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-2 col-form-label">Description:</label>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-10">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 col-xxl-5 mb-5">
            <label class="mb-2" for="notification-goes-to">Notification goes to:</label>
    ...
    <div class="d-flex gap-2 justify-content-end">
        <a href="index.php" class="btn btn-lg btn-outline-secondary" id="notification-cancel">Cancel</a>
        <input class="btn btn-lg btn-success" type="submit" id="notification-publish" name="notification-publish" value="Publish">
    </div>
</form>
<?php
include "footer.php";
